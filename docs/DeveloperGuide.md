...
**Field Conversion:**
Fields such as location and role have been converted to optional types (Optional<Location> and Optional<Role> respectively). 
...
**Getter Methods:**
Getter methods for optional fields (getLocation() and getRole()) have been adjusted to return Optional values, enabling proper handling of nullable fields.

**Equality Comparison:**
The equals() method has been updated to compare optional fields properly, ensuring consistency in object comparison.
...
Instead of using optional fields, individual command objects could be designed to handle undo/redo operations independently. 
This approach would involve implementing undo and redo logic within each command object, eliminating the need for optional fields in the Internship class.
